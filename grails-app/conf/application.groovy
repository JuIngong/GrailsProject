...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
    ...
    [pattern: '/location/**', 	 access: ['ROLE_ADMIN', 'ROLE_MODO', 'ROLE_USER']],
    [pattern: '/poi/create',     access: ['ROLE_ADMIN', 'ROLE_MODO']],
    [pattern: '/poi/edit/**',    access: ['ROLE_ADMIN', 'ROLE_MODO']],
    [pattern: '/poi/**',         access: ['ROLE_ADMIN', 'ROLE_MODO', 'ROLE_USER']],
    [pattern: '/poigrp/create',  access: ['ROLE_ADMIN', 'ROLE_MODO']],
    [pattern: '/poigrp/edit/**', access: ['ROLE_ADMIN', 'ROLE_MODO']],
    [pattern: '/poigrp/**',      access: ['ROLE_ADMIN', 'ROLE_MODO', 'ROLE_USER']],
    [pattern: '/role/**',        access: ['ROLE_ADMIN']],
    [pattern: '/user/create',    access: ['ROLE_ADMIN']],
    [pattern: '/user/edit/**',   access: ['ROLE_ADMIN', 'ROLE_MODO']],
	[pattern: '/user/account',   access: ['ROLE_ADMIN', 'ROLE_MODO', 'ROLE_USER']],
	[pattern: '/user/updateMe',   access: ['ROLE_ADMIN', 'ROLE_MODO', 'ROLE_USER']],
	[pattern: '/user/update',   access: ['ROLE_ADMIN', 'ROLE_MODO']],
    ...
    [pattern: '/image/**',       access: ['ROLE_ADMIN', 'ROLE_MODO', 'ROLE_USER']],
